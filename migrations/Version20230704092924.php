 ...
 */
final class Version20230704092924 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question DROP FOREIGN KEY FK_B6F7494E35F8C041');
        $this->addSql('ALTER TABLE question CHANGE id_u Id_U INT NOT NULL, CHANGE Titre_Q Titre_Q VARCHAR(255) NOT NULL, CHANGE Vote_Q Vote_Q INT DEFAULT 0 NOT NULL, CHANGE Signale_Q Signale_Q INT DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE question ADD CONSTRAINT fk_id_u2 FOREIGN KEY (Id_U) REFERENCES utilisateur (Id_U) ON UPDATE CASCADE ON DELETE CASCADE');

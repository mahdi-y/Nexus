 ...
 */
final class Version20230704090036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question DROP Id_U, CHANGE Vote_Q Vote_Q INT NOT NULL, CHANGE Signale_Q Signale_Q INT NOT NULL, CHANGE Titre_Q Titre_Q TEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD Id_U INT NOT NULL, CHANGE Titre_Q Titre_Q VARCHAR(50) NOT NULL, CHANGE Vote_Q Vote_Q INT DEFAULT 0 NOT NULL, CHANGE Signale_Q Signale_Q INT DEFAULT 0 NOT NULL');
